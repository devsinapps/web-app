...
export const jkReducer = ( state = jkPeg, action ) => {
  return state
}
...
export const jabatanReducer = ( state = jabatanPeg, action) => {
  return state
}

export const statusReducer = ( state = statusPeg, action) => {
  return state
}

export const golonganReducer = ( state = golonganPeg, action) => {
  return state
}