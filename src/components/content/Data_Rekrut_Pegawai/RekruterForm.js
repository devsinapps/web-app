...
export class RekruterForm extends React.Component{
	render(){
		...
		return(
			<Form onSubmit={this.props.inputRekruter}>
				...
				<FormGroup className='text-center'>
					...
					<Button color='warning' onClick={this.props.updateRekruter}>  Ubah </Button>{' '}
					<Button color='danger' onClick={this.props.deleteRekruter}> Hapus </Button>{' '}
					<Button color='primary' onClick={this.props.arsipRekruter}> Arsip </Button>{' '}
